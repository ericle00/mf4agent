# CODE ADAPTED from Lagent v0.2.2
# lagent/lagent/actions/ipython_interpreter.py
...
# SWITCH verbosity on and off:
verbosity = True # Prints commands and execution results when True
...
class IPythonInterpreter(BaseAction):
    ...
    Args:
        ...
        init_script (str, optional): Python code to run while initializing. For example
            to load data or define functions.
    """
    ...
    def __init__(self,
                 ...
                 enable: bool = True,
                 init_script: str = None): # code to run after initialization
        super().__init__(description, enable=enable)
    ...
    def _call(self,
        ...
        # result = result.strip('\n')
        if verbosity:
            print('OUTPUT FROM INTERPRETER CALL:', succeed, result)
...
if __name__ == '__main__':
    ...
    while True:
        print(code_interpreter.run((get_multiline_input('Enter python code:'))))